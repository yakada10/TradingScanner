...
def result_to_dict(result: Any) -> Dict:
    ...
    return {
        ...
        "breakdown": {
            ...
            "setup_quality_score":          round(bd.setup.total, 1),
            ...
            "sub_scores": {
                ...
                "move_stage":               round(bd.setup.move_stage, 1),
                "move_stage_label":         bd.setup.move_stage_label,
                "structure_quality":        round(bd.setup.structure_quality, 1),
                "room_to_move":             round(bd.setup.room_to_move, 1),
